...
- (void) sendAnchorAddedEventToUnity:(NSArray<ARAnchor*>*)anchors
{
    ...
    {
        id<UnityARAnchorEventDispatcher> dispatcher = [_classToCallbackMap objectForKey:NSStringFromClass([anchorPtr class])];
                                            ...
                                            UNITY_AR_ANCHOR_CALLBACK anchorRemovedCallback)
{
    ...
    [nativeSession->_classToCallbackMap setObject:anchorCallbacks forKey:NSStringFromClass([ARPlaneAnchor class])];
}
                                            ...
                                            UNITY_AR_USER_ANCHOR_CALLBACK userAnchorRemovedCallback)
{
    ...
    [nativeSession->_classToCallbackMap setObject:userAnchorCallbacks forKey:NSStringFromClass([ARAnchor class])];
}
                                               ...
                                               UNITY_AR_FACE_ANCHOR_CALLBACK faceAnchorRemovedCallback)
{
    ...
    [nativeSession->_classToCallbackMap setObject:faceAnchorCallbacks forKey:NSStringFromClass([ARFaceAnchor class])];
#endif
}
