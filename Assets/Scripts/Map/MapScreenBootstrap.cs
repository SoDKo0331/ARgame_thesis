...
public class MapScreenBootstrap : MonoBehaviour
{
    public static MapScreenBootstrap Instance { get; private set; }
    ...
    private static void EnsureExists()
    {
        ...
        GameObject bootstrapObject = new GameObject("MapScreenBootstrap");
        bootstrapObject.AddComponent<MapScreenBootstrap>();
    }
    ...
    private IEnumerator AttachToMainScene()
    {
        ...
        GameObject controllerObject = new GameObject("MapScreenController", typeof(RectTransform));
        controllerObject.transform.SetParent(canvas.transform, false);

        MapScreenController controller = controllerObject.AddComponent<MapScreenController>();
        controller.Initialize(
            FindObjectOfType<LocationTracker>(),
            tourismSpotManager);
    }
}
